...
export const metadata: Metadata = {
  ...
  title: "Mudderfuger 🛹🍻",
  // was "Generated by create next app" — the create-next-app default, which
  // is what Google was being handed as the description for the whole site.
  description:
    "The world's first AI skateboarder. Skate edits, Pyro Skateshop, and ways to get yourself into an episode.",
  openGraph: {
    title: "Mudderfuger 🛹🍻",
    description:
      "The world's first AI skateboarder. Skate edits, Pyro Skateshop, and ways to get yourself into an episode.",
    url: SITE,
    siteName: "Mudderfuger",
    type: "website",
  },
