...
const videos = [
  ...
  { id: 3, title: 'ep3: skatepark', url: 'https://mudderfuger.b-cdn.net/3_skatepark4x5_%20v3.mp4' },
  { id: 4, title: 'ep4: dinner', url: 'https://mudderfuger.b-cdn.net/3.5_dinner_4x5_%20Copy%2001.mp4' },
