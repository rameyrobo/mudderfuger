...
export default function Navbar() {
  return (
    <div className="flex flex-no-wrap gap-1 mt-4 text-3xl font-semibold uppercase flex-col-reverse md:flex-row md:gap-4 items-center">
      ...
      <a href="https://www.instagram.com/reel/DKp93PVTfZQ/?hl=en" className="text-2xl md:4xl font-arial-bold text-white focus:bg-black/90 focus-within:bg-black/90 hover:bg-black/90 transition-all px-5 py-1.5 rounded-sm tracking-wide focus:underline focus-within:underline hover:underline leading-4">Police Not Allowed</a>
    </div>
  );
}